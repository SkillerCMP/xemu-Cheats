...
EXPECTED_PROTECTED_METHOD_COUNT = 88
EXPECTED_PROTECTED_METHOD_DIGEST = "3e5e4119c82e58dbc04519682b2ae83578604254698741a4b3aa450b0310f19a"
...
def main() -> int:
    ...
    for addition in PASS4_HEADER_ADDITIONS + PASS8_HEADER_ADDITIONS:
    ...
    if sha256_text(normalized_header) != V188_PUBLIC_HEADER_SHA256:
        raise AssertionError("public MemoryTools header changed outside Pass-4 preference additions")
